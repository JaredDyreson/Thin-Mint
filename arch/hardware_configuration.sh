...
find /usr/share/X11/xorg.conf.d/ -type f -iname '*libinput.conf' | while read file; do
	cat /home/jared/Projects/dotfiles/trackpad/libinput.conf > "$file"
done
sudo gpasswd -a jared input
libinput-gestures-setup autostart
echo "[+] Libinput gestures service started"
sleep 10
cp /home/jared/Projects/dotfiles/trackpad/libinput-gestures.conf /home/jared/.config/libinput-gestures.conf
...
cp -ar /home/jared/Projects/dotfiles/graphics/dgpu-off.service /usr/lib/systemd/user/
